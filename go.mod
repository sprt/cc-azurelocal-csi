...
require (
	...
	github.com/kata-containers/kata-containers/src/runtime v0.0.0-20240319163420-192250c52e02
	...
	sigs.k8s.io/cloud-provider-azure/pkg/azclient/configloader v0.0.6
